...
class Laptop(models.Model):
	...
	received_from = models.ForeignKey(Provider, null=True, blank=True, on_delete=models.SET_NULL)
	model = models.ForeignKey(Laptop_Model, null=True, blank=True, on_delete=models.SET_NULL)
	os_installed =  models.ForeignKey(Operating_System, null=True, blank=True, on_delete=models.SET_NULL)
	does_it_boot = models.BooleanField(null=True)
	battery_wear_level =  models.IntegerField(null=True)
	...
	optimisation_script = models.BooleanField(null=True)
